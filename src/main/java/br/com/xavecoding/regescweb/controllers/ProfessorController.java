...
public class ProfessorController {
    ...
    public ModelAndView show(@PathVariable Long id) {
        ...
        if (optional.isPresent()) {
            ...
            return this.retornaErroProfessor("ERRO AO CONSULTAR!!! Professor #" + id + " não encontrado!");
        }
    ...
    public ModelAndView edit(@PathVariable Long id, RequisicaoFormProfessor requisicao) {
        ...
        if (optional.isPresent()) {
            ...
            return this.retornaErroProfessor("ERRO AO EDITAR!!! Professor #" + id + " não encontrado!");
        }
    }

    @PostMapping("/{id}")
    public ModelAndView update(@PathVariable Long id, @Valid RequisicaoFormProfessor requisicao, BindingResult
            bindingResult) {
        if (bindingResult.hasErrors()) {
            ...
            if (optional.isPresent()) {
                ...
                System.out.println("############## NÃO ACHOU A ID DO PROFESSOR " + id + "####### ");
                return this.retornaErroProfessor("ERRO AO ATUALIZAR!!! Professor #" + id + " não encontrado!");
    ...
    @GetMapping("/{id}/delete")
        ...
        try {
            ...
            mv = this.retornaErroProfessor("ERRO AO DELETAR!!! Professor #" + id + " não encontrado!");
